...
function setup() 
{
  ...
  stars_display = createSprite(50,20,30,30);
  stars_display.scale = 0.2;
  stars_display.addAnimation('empty',emptyStar);
  stars_display.addAnimation('oneStar',oneStar);
  stars_display.addAnimation('twoStar',stars);
  stars_display.changeAnimation('empty');
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star,20)==true){
     star.visible = false;
    stars_display.changeAnimation('oneStar');
    
   }

   if(collide(fruit,star2,20)==true){
    star2.visible = false;
    stars_display.changeAnimation('twoStar');
  }
}
